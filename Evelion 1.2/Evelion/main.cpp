...
void DrawMenu() {
    ...
    if (ImGui::BeginPopup("Box Color")) {
        ...
        BoxColor.R = static_cast<int>(boxTemp * 255.0f);
        BoxColor.G = static_cast<int>(boxTemp * 255.0f);
        BoxColor.B = static_cast<int>(boxTemp * 255.0f);
        BoxColor.A = 255;
        ImGui::EndPopup();
    }
    if (ImGui::BeginPopup("Name Color")) {
        ...
        NameColor.R = static_cast<int>(nameTemp * 255.0f);
        NameColor.G = static_cast<int>(nameTemp * 255.0f);
        NameColor.B = static_cast<int>(nameTemp * 255.0f);
        NameColor.A = 255;
        ImGui::EndPopup();
    }
